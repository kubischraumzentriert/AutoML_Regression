...
| 27 Missing-Data-Mechanismus-Audit (MCAR/MAR/MNAR) - ist Fehlen informativ statt naiv median-/mode-zu-imputieren? | keins (0) | offen (2026-09-14) - Luecke im bestehenden Trust-Layer (Leak-Audit/Drift/Komposition decken das nicht ab); geplant: pro Feature pruefen, ob eine Missingness-Indikatorspalte mit dem Ziel korreliert (Regression: Punktbiserial/Mittelwertvergleich; Klassifikation-Aequivalent: Chi2/Zielraten-Delta), plus ob Fehlen mit ANDEREN Features vorhersagbar ist (MAR-Hinweis) - gehoert in beide Templates |
