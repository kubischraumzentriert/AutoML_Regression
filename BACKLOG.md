...
| 31 Multi-Horizont-Forecasting - ein Modell fuer mehrere Vorlaufzeiten gleichzeitig statt separater Modelle je Horizont | `beijing-air-quality-panel` (1, `036_multi_horizon_forecasting.R`) | erledigt (2026-09-15) - "horizon-as-feature"-Ansatz (Zeilen gestapelt, bei 24h-Vorlauf nicht bekannte Spalten NA-maskiert, EIN Modell). Sauberer Trade-off: 1h-Horizont RMSE +1,41 schlechter (23,63 vs. 22,22 separates Modell), 24h-Horizont RMSE -0,69 besser (63,42 vs. 64,11) - kein klarer Gewinner, haengt von Betriebsvorteil (1 statt 2 Modelle) vs. letzte RMSE-Punkte ab. Nur 1 Projekt bisher, nicht ADR-003-reif (electricity-load-panel haette dafuer erst eine 24h-Variante gebraucht) |
