...
| 31 Multi-Horizont-Forecasting - ein Modell fuer mehrere Vorlaufzeiten gleichzeitig statt separater Modelle je Horizont | keins (0) | offen (2026-09-14) - Erweiterung der Panel-Arbeit (Beijing hat 1h+24h als GETRENNTE Referenzlaeufe, `026`/`027`); Frage: hilft ein Multi-Output-Modell (oder ein Modell mit Horizont als Feature) gegenueber separaten Einzelhorizont-Modellen? |
