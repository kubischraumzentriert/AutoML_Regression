...
| 26 `combined_task_helper.R` - EIN gemeinsamer Task aus Train+Test statt zwei getrennter Tasks | `beijing-air-quality-panel` (Falle 3x aufgetreten trotz Dokumentation: `026`, `029` zweimal) | erledigt (2026-09-11) - Falle war seit Kandidat 8 nur als Prosa in `WORKFLOW_GUARDS.md` #8 dokumentiert, verhinderte das erneute Hineinlaufen aber NICHT; jetzt als Code-Baustein `build_combined_task_regr()` zurueckgefuehrt, `test_combined_task_helper.R` gruen (5 Checks) |
